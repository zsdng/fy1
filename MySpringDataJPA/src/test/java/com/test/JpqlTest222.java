...
public class JpqlTest222 {
    ...
    public void  testFindJPQL() {
        ...
        System.out.println( customerDao.findJpql("王培毅"));
    }
 /*   @Test
    public void  testFindJPQL22() {
        Customer customer =new Customer();
        customer.setCustName("王培毅");
        customer.setCustLevel("4242");
        System.out.println( customerDao.findJpql2(customer));
    }*/
